...
use Bruvinsky\HighschoolBundle\Form\SubjectType;
...
//        $entities = $em->getRepository('BruvinskyHighschoolBundle:Subject')->findAll();
//        return $this->render('BruvinskyHighschoolBundle:Subject:index.html.twig', array(
//            'entities' => $entities,
//        ));

        $qb = $em->createQueryBuilder();
        $qb->select('sb')
            ->from('BruvinskyHighschoolBundle:Subject', 'sb')
            ->orderBy('sb.id', 'ASC');;
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('BruvinskyHighschoolBundle:Subject:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BruvinskyHighschoolBundle:Subject')->find($id);
        ...
        return $this->render('BruvinskyHighschoolBundle:Subject:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BruvinskyHighschoolBundle:Subject:edit.html.twig', array(
            'entity'      => $entity,
